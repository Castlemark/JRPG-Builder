...
class Validation:
	...
	const stats := [{"strength" : NUMBER}, {"dexterity" : NUMBER}, {"constitution" : NUMBER}, {"critic" : NUMBER}, {"defence" : NUMBER}, {"speed" : NUMBER}, {"health" : NUMBER}, {"strain" : NUMBER}, {"evasion" : NUMBER}, {"evasion" : NUMBER}]
